...
\begin{enumerate}[a)]
  ...
  Die Klasse std::deque ist sozusagen ein Vektor, wo Änderungen am ersten und
  am letzten Element möglich sind. Hierfür gibt es unterschiedliche Befehle.
  $Push\_front$ ermöglicht es, ein Element am Anfang hinzuzufügen und
  $Push\_back$ hingegen am Ende.\\ Die Klasse std::stack zeichnet sich daraus
