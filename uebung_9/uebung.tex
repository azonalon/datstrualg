...
\begin{enumerate}[a)]
	...
	\begin{figure}[h!]
		\centering	
		\includegraphics[width=0.8\textwidth]{./aufgabe_b/b1}
		\caption{Erstellen eines Suchbaums}
	\end{figure}
	
		\begin{figure}[h!]
			\centering	
			\includegraphics[width=0.8\textwidth]{./aufgabe_b/b2}
			\caption{Erstellen eines Suchbaums}
		\end{figure}
		...
		\begin{figure}[h!]
			\centering	
			\includegraphics[width=0.8\textwidth]{./aufgabe_c/c1}
			\caption{Erstellen eines Suchbaums}
		\end{figure}
		
		\begin{figure}[h!]
			\centering	
			\includegraphics[width=0.8\textwidth]{./aufgabe_c/c2}
			\caption{Erstellen eines Suchbaums}
		\end{figure}	
		
		\begin{figure}[h!]
			\centering	
			\includegraphics[width=0.8\textwidth]{./aufgabe_c/c3}
			\caption{Erstellen eines Suchbaums}
		\end{figure}	
