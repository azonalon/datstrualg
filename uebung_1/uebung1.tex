...
Nimmt man z.B. die Liste $\lbrace 1, 19, 21, 22\rbrace$, so arbeitet die Coin-Changing-Methode mit dem Greedy-Algorithmus f\"ur die Zerlegung der Zahl 42 nicht optimal. W\"urde man diesen Algorithmus verwenden, w\"urde zun\"achst die 22 aus der Liste ausgew\"ahlt. Der Rest sind 20. Also w\"urde im n\"achsten Schritt die 19 ausgew\"ahlt. Der Rest 1 wird durch die 1 aufgef\"ullt. Man braucht also 3 Elemente der Liste.

Optimal w\"are allerdings die Zerlegung $42 = 21 + 21$, da dort nur 2 Elemente ben\"otigt werden. Diese Zerlegung findet der Greedy-Algorithmus aber nicht.
